...
if (isset($_POST["submit"])) {
    ...
    if (empty($errors)) {
        if (store_submits_to_file($name, $email)) {
            ...
            $message .= "</div>";
            echo $message;
            exit("<center> Contact saved successfully" . "<br> To visit all contacts <a href='index.php?view=display'> click here </a> <center>");
        } else {
            exit("Error saving contact");
        }
    }
